...
var setup = function setup() {
  ...
  var rimayBody = document.body; // Toggle Menu
  // -----------------------------------------------------------------------------

  qs('.js-toggle-menu').addEventListener('click', function (e) {
    e.preventDefault();
